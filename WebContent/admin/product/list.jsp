...
<body>
	...
	<form id="Form1" name="Form1"
		...
		method="post">
		商品名稱：<input type="text" name="panme" value="${condition.pname}">&nbsp;&nbsp;&nbsp;
		熱門：<select id="isHot" name="isHot">
							...
							<c:forEach items="${productList}" var="pro" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/adminProductEdit?pid=${pro.pid}">
											<img
