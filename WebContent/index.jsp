			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath}/productInfo?pid=${hotpro.pid}&cid=${cid}&currentPage=${pageBean.currentPage}" style='color:#666'>${hotpro.pname}</a></p>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						...
						<p><a href="${pageContext.request.contextPath}/productInfo?pid=${newpro.pid}&cid=${cid}&currentPage=${pageBean.currentPage}" style='color:#666'>${newpro.pname}</a></p>
