...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pageBean.productList }" var="product">
			<div class="col-md-2" style="height: 250px">
				<a href="${pageContext.request.contextPath}/productInfo?pid=${product.pid}&cid=${cid}&currentPage=${pageBean.currentPage}"> <img
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pageBean.currentPage!=1 }">
				<li><a
					href="${pageContext.request.contextPath}/productListById?cid=${cid }&currentPage=${pageBean.currentPage-1}"
					aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
			</c:if>
			...
			<c:forEach begin="1" end="${pageBean.totalPage }" var="page">
				...
				<c:if test="${pageBean.currentPage!=page }">
					<li><a
						href="${pageContext.request.contextPath}/productListById?cid=${cid }&currentPage=${page}">${page }</a></li>
				</c:if>
			</c:forEach>
