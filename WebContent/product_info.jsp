	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="default.jsp">首页&nbsp;&nbsp;&gt;</a> <a href="${pageContext.request.contextPath}/productListById?cid=${cid }&currentPage=${currentPage}">分类&nbsp;&nbsp;&gt;</a>
				<a>详细页面</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div>
					<a href="${pageContext.request.contextPath}/productListById?cid=${cid }&currentPage=${currentPage}">返回列表页面</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
